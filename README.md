...
## Features
* View __branch history__.
* View __file history__.
* View __folder history__.
* Select a commit from the history view to see the __committed changes__.
* Input a commit sha1 to see the __committed changes__.
* View __all the diffs__ between current branch and the selected one.
* View the __diff of a file__ between current branch and the selected one.
* View the __diff of a folder__ between current branch and the selected one.
